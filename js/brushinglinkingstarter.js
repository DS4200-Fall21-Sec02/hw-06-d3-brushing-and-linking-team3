...
d3.csv("data/iris.csv").then((data) => {
  ...
  //Scatterplot 1
  {
    ...
    //TODO: Define a brush
      ...
      //Brush has been defined as per resource provided
      var brush1 =
    ...
    //TODO: Add brush to the svg
      //Brush has been called to svg as per resource provided
      svg1.call(brush1)
  ...
  //TODO: Scatterplot 2 (show Sepal width on x-axis and Petal width on y-axis)
    ...
    //Barchart (Code is similar to IC4)
    {
    ...
    let x = d3.scaleBand().range([0, width]).padding(0.13),
        ...
        //This step allows us to manipulate the data in a way that is convenient for our plotting purposes

        //Create a list of the specie types
        var speciesList = data.map(function(d) { return d.Species; })
        //Initialize each specie count as 0
        var setosa = 0
        var versicolor= 0
        var virginica = 0;

        //Parse the list and count each occurence of each specie type
        ...
        //Create a new List which displays the specie count of each specie
        ...
        //Create the Bar Chart with speciesData defined
  ...
  //Removes existing brushes from svg
    ...
    function updateChart2(brushEvent) {
      ...
      //TODO: Select bars in bar chart based on species selected in Scatterplot 2
        ...
        //This function is called to keep track of the species in our selectedSpecies Set
